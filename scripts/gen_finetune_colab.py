...
cells.append(code(
    ...
    "    # QuestKG.predict signature: predict(query, expected_types=None, query_meta=None)\n"
    "    # query_meta is the FULL query dict — predict extracts anchors (q_entity)\n"
    "    # and graph_triple_idx from it. Passing wrong kwargs raises TypeError.\n"
    "    res = method.predict(query_dict['question'], query_meta=query_dict)\n"
    ...
    "            gold = set(gold_raw) if isinstance(gold_raw, list) else {gold_raw}\n"
    ...
    "    if n_errors > 0:\n"
    "        print(f'  total errors: {n_errors} (first 3 shown above)')\n"
    "    pbar.close()\n"
    ...
    "    pbar.close()\n"
    "    if n_test_errors > 0:\n"
    "        print(f'  total test errors: {n_test_errors}')\n"
